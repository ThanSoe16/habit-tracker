...
export const EXERCISE_GUIDES: Record<string, ExerciseGuide> = {
  'Basic Crunches (Abs)': {
    ...
    category: 'Core',
    targetMuscles: ['Rectus Abdominis (Abs)'],
    equipment: 'Bodyweight and Exercise Mat',
    difficulty: 'Beginner',
    summary: 'A basic floor crunch that works the abdominal muscles with a small, controlled curl.',
    steps: [
      'Lie on your back with knees bent and feet flat on the mat, about hip-width apart.',
      'Cross your arms over your chest and keep your neck relaxed.',
      'Exhale and tighten your abs to lift your head and shoulder blades slightly off the mat.',
      'Keep your lower back and pelvis supported, then lower slowly as you inhale.',
    ],
    proTips: [
      'Keep a little space between your chin and chest and avoid pulling on your neck.',
      'Use a small, controlled movement and keep both feet on the mat.',
    ],
  },
  'Reverse Fly (Rear Delts)': {
    ...
    equipment: 'Dumbbells',
    difficulty: 'Beginner',
    summary: 'A rear-shoulder exercise included with your back workouts.',
    steps: [
      'Hold dumbbells and hinge forward at the hips with a neutral back.',
    ...
    proTips: ['Use a light weight and avoid swinging or shrugging your shoulders.'],
  },
  'Sumo Squat': {
    name: 'Sumo Squat',
    category: 'Legs',
    targetMuscles: ['Quadriceps', 'Glutes', 'Inner Thighs'],
    equipment: 'Bodyweight, Dumbbell, or Kettlebell',
    difficulty: 'Beginner',
    summary: 'A wide-stance squat for the legs and glutes.',
    steps: [
      'Stand with your feet wider than shoulder width and toes turned slightly outward.',
      'Hold a weight in front of you, or begin with bodyweight.',
      'Bend your hips and knees, keeping your knees aligned with your toes.',
      'Lower to a comfortable depth, then push through your feet to stand.',
    ],
    proTips: ['Keep your heels planted and use a stance that feels comfortable.'],
  },
  'Wrist Curl (Forearms)': {
    name: 'Wrist Curl (Forearms)',
    category: 'Arms',
    targetMuscles: ['Forearm Wrist Flexors'],
    equipment: 'Dumbbells and Bench',
    difficulty: 'Beginner',
    summary: 'A palms-up wrist curl for the forearms.',
    steps: [
      'Sit with your forearms supported on your thighs or a bench, palms facing up.',
      'Let your hands extend just beyond the support while holding light dumbbells.',
      'Curl your wrists upward while keeping your forearms still.',
      'Lower slowly through a comfortable range.',
    ],
    proTips: ['Keep a secure grip and avoid forcing the wrist at either end of the movement.'],
  },
  'Reverse Wrist Curl (Forearms)': {
    name: 'Reverse Wrist Curl (Forearms)',
    category: 'Arms',
    targetMuscles: ['Forearm Wrist Extensors'],
    equipment: 'Dumbbells and Bench',
    difficulty: 'Beginner',
    summary: 'A palms-down wrist curl for the back of the forearms.',
    steps: [
      'Sit with your forearms supported and palms facing down, holding light dumbbells.',
      'Position your hands just beyond the edge of the support.',
      'Raise the backs of your hands while keeping your forearms still.',
      'Lower slowly through a comfortable range.',
    ],
    proTips: ['Start light and keep the movement controlled.'],
  },
  'Reverse Curl (Forearms)': {
    name: 'Reverse Curl (Forearms)',
    category: 'Arms',
    targetMuscles: ['Brachioradialis (Forearms)', 'Brachialis', 'Biceps'],
    equipment: 'EZ Bar or Dumbbells',
    difficulty: 'Beginner',
    summary: 'An overhand-grip curl for the forearms and upper arms.',
    steps: [
      'Stand holding the weight with an overhand grip, palms facing your thighs.',
      'Keep your elbows near your sides and wrists straight.',
      'Bend your elbows to curl the weight upward without swinging your torso.',
      'Lower slowly to the starting position.',
    ],
    proTips: ['Use a weight you can lift without bending your wrists.'],
  },
  'Incline Chest Press': {
