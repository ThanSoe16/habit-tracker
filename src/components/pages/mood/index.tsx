...
import { MoodHeader } from './_components/mood-header';
...
export default function MoodPage() {
  ...
  return (
    <div className="min-h-screen bg-background dark:bg-zinc-950 text-foreground selection:bg-blue-500/10 pb-28">
