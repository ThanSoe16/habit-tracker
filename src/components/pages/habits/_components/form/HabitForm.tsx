...
const HabitForm = ({ form, isEdit }: { form: any; isEdit?: boolean }) => {
  ...
  return (
    <div className="flex flex-col p-4 space-y-6 pb-8 w-full max-w-lg mx-auto bg-[#f4f7fd] dark:bg-zinc-950 min-h-screen">
      {/* Top Header */}
      ...
      <FieldGroup className="space-y-6">
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          <Button
            type="submit"
            className="h-13 rounded-2xl bg-[#2563eb] hover:bg-[#1d4ed8] text-white font-bold shadow-lg shadow-blue-500/30"
          >
