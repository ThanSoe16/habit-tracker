...
import { parseTimeTakenToSeconds } from '@/utils/timeUtils';
  ...
  return (
    <div className="relative py-2 px-1">
      ...
      >
        ...
        {/* <div className="absolute top-[34px] left-6 right-6 h-[3px] bg-[#6366f1]/30 -z-10 rounded-full" /> */}
            ...
            if (entry) {
              if (typeof entry === 'boolean') {
                ...
                if (entry.completed) completedCount++;
                  ...
                  parseTimeTakenToSeconds(entry.timeTaken) >= ((h.goalValue || 1) * (h.timeUnit === 'hr' ? 3600 : 60))
                ) {
                  completedCount++;
                }
              }
            ...
            return (
              <div key={i} className=" w-[calc(100%/7)]">
                <button
                  ...
                  className="flex flex-col items-center justify-center shrink-0 py-1 px-1 rounded-full bg-[#6366f1] text-white transition-all duration-200 scale-105 z-20 gap-[2px]"
                >
            ...
            >
              ...
              {isPastOrToday ? (
                isFullyCompleted ? (
                  ...
                  <div className="w-8 h-8 rounded-full bg-[#6366f1] text-white font-black text-xs flex items-center justify-center shadow-2xs">
                    {d.day}
                  </div>
                ) : isPartiallyCompleted ? (
                  ...
                  <div className="relative w-9 h-9 flex items-center justify-center">
                    <svg className="w-9 h-9 -rotate-90" viewBox="0 0 36 36">
                      ...
                      <circle
                        ...
                        cy="18"
                        r="14"
                        className="stroke-[#6366f1] transition-all duration-300"
                        strokeWidth="3.5"
                        strokeLinecap="round"
                        fill="transparent"
                        strokeDasharray="88"
