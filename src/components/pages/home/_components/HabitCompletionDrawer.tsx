          ...
          <div className="relative w-56 h-56 flex items-center justify-center">
            ...
            <svg className="w-52 h-52 -rotate-90" viewBox="0 0 100 100">
              ...
              <circle
                ...
                cy="50"
                r="40"
                className="stroke-[#b2f5ea] dark:stroke-emerald-950/60"
                strokeWidth="7"
                fill="transparent"
              />
              {/* Active Progress Arc */}
              <circle
                ...
                cy="50"
                r="40"
                className="stroke-[#00c49f] transition-all duration-300"
                strokeWidth="7"
                strokeLinecap="round"
                fill="transparent"
            ...
            <button
              ...
              className="absolute -left-2 top-1/2 -translate-y-1/2 w-12 h-12 rounded-full bg-[#e6fffa] dark:bg-emerald-950/80 text-[#00c49f] flex items-center justify-center font-bold text-2xl hover:scale-105 active:scale-95 transition-all shadow-xs"
            >
            ...
            <button
              ...
              className="absolute -right-2 top-1/2 -translate-y-1/2 w-12 h-12 rounded-full bg-[#e6fffa] dark:bg-emerald-950/80 text-[#00c49f] flex items-center justify-center font-bold text-2xl hover:scale-105 active:scale-95 transition-all shadow-xs"
            >
          ...
          <div className="w-full flex items-center justify-between pt-2">
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                className="p-2 text-[#00c49f] hover:bg-[#e6fffa] dark:hover:bg-emerald-950/40 rounded-full transition-colors"
                title="Complete goal"
              >
                <FastForward className="w-5 h-5 fill-[#00c49f]" />
              </button>
              {/* Close / Clear Icon */}
              <button
                type="button"
            ...
            <Button
              onClick={handleSave}
              type="button"
              className="py-3.5 px-8 rounded-full text-base font-black bg-[#00c49f] hover:bg-[#00b390] text-white shadow-lg shadow-teal-500/30 active:scale-98 transition-all"
            >
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center gap-3 pt-2">
            ...
            <Button
              onClick={handleSave}
              type="button"
              className="flex-1 h-14 rounded-full text-base font-black bg-[#00c49f] hover:bg-[#00b390] text-white shadow-lg shadow-teal-500/30 active:scale-98 transition-transform"
            >
              Update
            </Button>
          </div>
