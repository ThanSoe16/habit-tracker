...
import { PieChart, Mic, Image as ImageIcon, Video, HardDrive, Sparkles } from 'lucide-react';
import { useMediaStore } from '@/store/use-media-store';

export default function StoreGeneralsReportPage() {
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="bg-gradient-to-br from-violet-600 to-indigo-700 rounded-3xl p-6 text-white shadow-xl shadow-violet-500/20 space-y-4">
