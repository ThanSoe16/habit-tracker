...
import { useGymStore, PlanExercise, Exercise } from '@/store/use-gym-store';
...
export function PlanEditor() {
  ...
  const handleSelectExercise = (exercise: Exercise, sets: number, reps: string, weight?: string) => {
          ...
          <div className="space-y-3">
            ...
            {currentDay.exercises.length === 0 ? (
              <div className="text-center py-8 px-4 bg-gray-50 dark:bg-zinc-800/30 rounded-2xl border border-dashed border-gray-200 dark:border-zinc-800">
                ...
                <p className="text-xs text-muted-foreground font-medium">No exercises planned for {currentDay.dayName} yet.</p>
                <button
                  onClick={() => setIsModalOpen(true)}
