...
export default function CurrencyExchangePage() {
  ...
  // Filtered Exchange History List (budgetEntries with type === 'exchange')
      ...
      <div className="w-full max-w-lg mx-auto p-4 space-y-5">
        ...
        <header className="flex justify-between items-center py-1">
          ...
          <button
            ...
            className="px-3 py-1.5 rounded-full bg-blue-50 dark:bg-blue-950/40 text-blue-600 dark:text-blue-400 font-extrabold text-xs flex items-center gap-1.5 hover:bg-blue-100 transition-colors"
          >
              ...
              {exchangeEntries.map((entry) => {
                ...
                return (
                  ...
                  >
                    ...
                    {/* Exchange Conversion Details Box */}
