...
const PRESET_EXERCISES = [
  {
    ...
    category: 'Chest',
    path: 'public/work-out/chests/incline-chest.png',
  },
  ...
  { name: 'Chest Flyes', category: 'Chest', path: 'public/work-out/chests/chest-flyes.png' },
  {
    ...
    category: 'Chest',
    path: 'public/work-out/push-ups/standard-push-up.png',
  },
  {
    name: 'Decline Push-ups (Upper Chest)',
    category: 'Chest',
    path: 'public/work-out/push-ups/decline-push-up.png',
  },
  {
    name: 'Incline Push-ups (Lower Chest)',
    category: 'Chest',
    path: 'public/work-out/push-ups/incline-push-up.png',
  },
  {
    name: 'Diamond Push-ups (Triceps & Inner Chest)',
    category: 'Chest',
    path: 'public/work-out/push-ups/diamond-push-up.png',
  },
  {
    name: 'Wide-Grip Push-ups (Outer Chest)',
    category: 'Chest',
    path: 'public/work-out/push-ups/wide-grip-push-ups.png',
  },
  {
    name: 'Pike Push-ups (Shoulders)',
    category: 'Shoulders',
    path: 'public/work-out/push-ups/pike-push-up.png',
  },
  {
  ...
  { name: 'Pull-ups / Lat Pulldown', category: 'Back', path: 'public/work-out/back/pull-down.png' },
  {
    ...
    category: 'Back',
    path: 'public/work-out/back/barbell-bent-over-row.png',
  },
  { name: 'Seated Cable Row', category: 'Back', path: 'public/work-out/back/seated-cable-row.png' },
  {
    name: 'Single-Arm Dumbbell Row',
    category: 'Back',
    path: 'public/work-out/back/single-arm-dumbbell-row.png',
  },
  ...
  { name: 'Calf Raises', category: 'Legs', path: 'public/work-out/legs/calf-raises.png' },
  {
    name: 'Shoulder Press',
    category: 'Shoulders',
    path: 'public/work-out/shoulders/shoulder-press.png',
  },
  {
    name: 'Lateral Raises',
    category: 'Shoulders',
    path: 'public/work-out/shoulders/lateral-raises.png',
  },
  {
    name: 'Front Dumbbell Raise',
    category: 'Shoulders',
    path: 'public/work-out/shoulders/front-dumbbell-raise.png',
  },
  {
    name: 'Triceps Overhead Extension',
    category: 'Arms',
    path: 'public/work-out/triceps/triceps-overhead-extension.png',
  },
  {
    name: 'Triceps Pushdown',
    category: 'Arms',
    path: 'public/work-out/triceps/triceps-pushdown.png',
  },
  {
    name: 'Barbell Bicep Curl',
    category: 'Arms',
    path: 'public/work-out/biceps/barbell-bicep-curl.png',
  },
  {
    name: 'Dumbbell Hammer Curl',
    category: 'Arms',
    path: 'public/work-out/biceps/dumbbell-hammer-curl.png',
  },
  { name: 'Plank', category: 'Core', path: 'public/work-out/core-abs/plank.png' },
  {
    name: 'Hanging Leg Raise',
    category: 'Core',
    path: 'public/work-out/core-abs/hanging-leg-raise.png',
  },
  {
    name: 'Cable Crunch (Upper Abs)',
    category: 'Core',
    path: 'public/work-out/core-abs/cable-crunch.png',
  },
  {
    name: 'Russian Twists (Obliques)',
    category: 'Core',
    path: 'public/work-out/core-abs/russian-twists.png',
  },
  {
    name: 'Ab Wheel Rollout',
    category: 'Core',
    path: 'public/work-out/core-abs/ab-wheel-rollout.png',
  },
  {
    name: 'Mountain Climbers',
    category: 'Core',
    path: 'public/work-out/core-abs/mountain-climbers.png',
  },
  {
    name: 'Reverse Crunch (Lower Abs)',
    category: 'Core',
    path: 'public/work-out/core-abs/reverse-crunch.png',
  },
  {
    name: 'Treadmill Running',
    category: 'Cardio',
    path: 'public/work-out/core-abs/treadmill-running.png',
  },
  {
    name: 'Stationary Cycling',
    category: 'Cardio',
    path: 'public/work-out/core-abs/stationary-cycling.png',
  },
];
...
async function seedWorkoutImages() {
  ...
  try {
    const { data: bucketData, error: bucketErr } = await supabase.storage.createBucket(
      'workout-images',
      {
        public: true,
  ...
  for (const item of PRESET_EXERCISES) {
    ...
    const { error: dbErr } = await supabase.from('workout_exercises').upsert(
      {
        name: item.name,
